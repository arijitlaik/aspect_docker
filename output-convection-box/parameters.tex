...
{\it Value:} output-convection-box
...
{\it Value:} p=0.01, L=1, pi=3.1415926536, k=1
...
{\it Value:} (1.0-z) - p*cos(k*pi*x/L)*sin(pi*z)
...
{\it Value:} velocity statistics, temperature statistics, heat flux statistics, visualization
